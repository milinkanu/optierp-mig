"""Selling workspace endpoint — stats for the Selling workspace page."""
...
from app.services import selling_workspace as svc
...
async def workspace_stats(
    ...
    return await svc.get_workspace_stats(db, current_user.company_id)
